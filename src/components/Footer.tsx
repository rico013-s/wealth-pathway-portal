    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-white">Companii</h3>
            <ul className="space-y-2">
              <li><a href="#companies" className="text-gray-400 hover:text-gold-500">Partenerii Noștri</a></li>
              <li><a href="#comparison" className="text-gray-400 hover:text-gold-500">Compară Servicii</a></li>
              <li><a href="#" className="text-gray-400 hover:text-gold-500">Devino Partener</a></li>
              <li><a href="#" className="text-gray-400 hover:text-gold-500">Povești de Succes</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-gray-500 hover:text-gold-500 text-sm">Politică de cookies</a>
          </div>
        </div>
      </div>
    </footer>
